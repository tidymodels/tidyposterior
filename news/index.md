...
- New
  [`compare_to_leader()`](https://tidyposterior.tidymodels.org/reference/compare_to_leader.md)
...
- New
  [`initialize_keys()`](https://tidyposterior.tidymodels.org/reference/initialize_keys.md)
...
- An optional formula argument was added to
  [`perf_mod.rset()`](https://tidyposterior.tidymodels.org/reference/perf_mod.md)
  and
  [`perf_mod.data.frame()`](https://tidyposterior.tidymodels.org/reference/perf_mod.md).
